...
This repository contains a suggested solution to the Gilded Rose Kata that involves updating a legacy codebase to add new behavior whotout breaking the existing one. The suggested solution focuses on refactoring the code to make it more maintainable, extensible, and testable.

## Getting Started
A starting point for the Gilded Rose kata using dotnet core,c# and Verify - xunit
...
To implement this project, i used as IDE Microsoft Visual Studio 2022 Community (Build,Test Explorer)